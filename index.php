...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    <div class="container">
      <a class="navbar-brand" href="../welfare/">Welfare</a>
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item active"><a href="../welfare/" class="nav-link">Home</a></li>
          ...
          <div class="col-md-2">
             <div class="ftco-footer-widget mb-4 ml-md-4">
              ...
              <ul class="list-unstyled">
                <li><a href="../welfare/" class="py-2 d-block">Home</a></li>
                <li><a href="about" class="py-2 d-block">About</a></li>
                <li><a href="donate.php" class="py-2 d-block">Donate</a></li>
                <li><a href="cause.php" class="py-2 d-block">Causes</a></li>
                <li><a href="event.php" class="py-2 d-block">Event</a></li>
                <li><a href="blogpg.php" class="py-2 d-block">Blog</a></li>
              </ul>
            </div>
          </div>
          <div class="col-md-3">
