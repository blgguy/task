    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item active"><a href="causes.php" class="nav-link">Causes</a></li>
      		...
      		<div class="col-md-4 ftco-animate">
      			<div class="cause-entry">
    					...
    					<div class="text p-3 p-md-4">
    						<h3><a href="#"><?php echo $Ptitle;?></a></h3>
    						<p><?php echo $Ppost;?><!--Even the all-powerful Pointing has no control about the blind texts it is an almost unorthographic life--></p>
    						<span class="donation-time mb-3 d-block">Last donation on <?php echo $Pdate;?><!--1w ago--></span>
