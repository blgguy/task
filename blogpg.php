...
$blogPost = new Engine();
$postVw = $blogPost->getPage('blogpost');
...
$totalRecords = $blogPost->getAllRecords('blogpost');
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item active"><a href="blogpg.php" class="nav-link">Blog</a></li>
      ...
      **/
        ?> 
          <div class="col-md-4 d-flex ftco-animate">
              ...
              <a href="blog.php?view=<?php echo $Id;?>" class="block-20" style="background-image: url('<?php echo $Pimg;?>');">
              </a>
              <div class="text p-4 d-block">
                ...
                <h3 class="heading mt-3"><a href="#"><?php echo $Ptitle;?></a></h3>
                <p><?php echo $Ppost;?></p>
              </div>
            </div>
          </div>
