...
$getId = $_GET["ref"];
$View  = $blogPost->ViewByKey('event',$getId);
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8 ftco-animate">
            <h2 class="mb-3"><?php echo $Ptitle; ?></h2>
              <img src="<?php echo $Pimg; ?>" alt="<?php echo $Ptitle; ?>" class="img-fluid">
            </p>
            <p>By <?php echo $Pauthor; ?></p><span> Posted on <?php echo $Pdate; ?></span>
            <p><?php echo $Ppost; ?></p>
