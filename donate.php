...
$blogPost = new Engine();
$postVw = $blogPost->BView('donation');
?>
<!DOCTYPE html>
<html lang="en">
  <head>
  ...
  $Pname   = $key['name'];
  $denoted    = $key['amountDonated'];
  $Pimg     = 'images/'.$key['image'];
  $causes  = $key['causes'];
  $Pdate    = $key['date'];
  $PAddeddate    = $key['dateAdded'];
?>
        	<div class="col-lg-4 d-flex mb-sm-4 ftco-animate">
        		<div class="staff">
        			<div class="d-flex mb-4">
        				<div class="img" style="background-image: url(<?php echo $Pimg;?>);"></div>
        				<div class="info ml-4">
        					<h3><a href="teacher-single.html"><?php echo $Pname;?></a></h3>
        					<span class="position">Donated On <?php echo $Pdate;?></span>
        					<div class="text">
		        				<p>Donated <span>$<?php echo $denoted;?></span> for <a href="#"><?php echo $causes;?></a></p>
		        			</div>
        				</div>
        			</div>
        		</div>
